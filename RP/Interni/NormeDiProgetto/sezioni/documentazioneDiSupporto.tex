...
\begin{itemize}
	...
	\begin{itemize}
		\item \textbf{Ruoli di \gl{progetto}}: ogni nome di un ruolo di \gl{progetto} deve essere scritto con la lettera iniziale maiuscola e con lo stile corsivo. Questo viene automatizzato utilizzando il comando \file{\textbackslash{CodiceRuolo}};
...
\paragraph{Strumenti}
 \subparagraph{Git}
 Lo strumento usato per il versionamento è \gl{Git}, in combinazione con il servizio di host GitHub e con GitHub desktop.
