...
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{images/Class__interface__ ConversationsDAO.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{images/Class__interface__ GuestsDAO.png}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		Costruttore che si occupa di effettuare la dependency injection di \file{UsersDAO}, \file{JSONWebTokenModule}, \file{RulesDAO};\\
		Parametri:
		\begin{itemize}
			\item \file{jwt: JSONWebTokenModule} \\
...
\begin{itemize}
	...
	\item \textbf{Utilizzo}: ridefinisce il metodo \file{next} in modo che venga sollevata un'eccezione alla sua chiamata;
	\item \textbf{Metodi}:
	\begin{itemize}
		\item[] \file{+ next(): void} \\
...
\begin{itemize}
	...
	\item \textbf{Utilizzo}: implementa il metodo \file{next} di \file{Observer}, in modo che riceva dati di tipo \file{Guest};
	\item \textbf{Metodi}:
	\begin{itemize}
...
\begin{figure}[h]
	...
	\caption{Back-end::MemberObservable}
\end{figure}
\begin{itemize}
...
\begin{figure}[h]
	...
	\caption{Back-end::MemberObserver}
\end{figure}
\begin{itemize}
	...
	\item \textbf{Utilizzo}: implementa il metodo \file{next()} dell'interfaccia, in maniera tale che accetti dati di tipo \file{Member};
	\item \textbf{Metodi}:
	\begin{itemize}
...
\hypertarget{MembersSlackDAO_label}{\paragraph{MembersSlackDAO}}
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{images/ClassMembersSlackDAO.png}
	\caption{Back-end::MembersSlackDAO}
\end{figure}
\begin{itemize}
	\item \textbf{Nome}: \file{MembersSlackDAO};
	\item \textbf{Tipo}: \file{Class};
...
\begin{figure}[h]
	...
	\caption{Back-end::UsersObservable}
\end{figure}
\begin{itemize}
...
\begin{figure}[h]
	...
	\caption{Back-end::UsersObserver}
\end{figure}
\begin{itemize}
...
\end{lstlisting};
	...
	\begin{itemize}
		...
		\item[] \file{- notification: NotificationModule} \\
	...
	\item \textbf{Metodi}:
	\begin{itemize}
		\item[] \file{+ <<Create>> VAMessageListener(conv\_dao: ConversationsDAO, guests\_dao: GuestsDAO, notification: NotificationModule): VAMessageListener} \\
		...
		\begin{itemize}
			...
			\item \file{notification: NotificationModule} \\
			Parametro contenente il \file{NotificationModule} del quale si vuole effettuare la dependency injection;
		\end{itemize}
...
\end{itemize}
----
Fornisce un metodo pubblico che si occupa di implementare l'handler per la lambda function collegata all'endpoint utilizzato dal client. Definisce inoltre una serie di metodi privati che si occupano di portare a termine le diverse azioni che vengono richieste dall'assistente virtuale;
	\item \textbf{Attributi}:
	\begin{itemize}
	...
	\item \textbf{Metodi}:
	\begin{itemize}
		\item[] \file{+ <<Create>> createAuthAPI(vocal: VocalLoginModule, jwt: JSONWebTokenModule, rp: RequestPromiseModule, stt: STTModule, sns: AWS::SNS): AuthAPI} \\
		Costruttore della classe \file{AuthAPI} che permette la dependency injection dei moduli richiesti;\\
		Parametri:
		\begin{itemize}
			\item \file{vocal: VocalLoginModule} \\
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{images/Class__interface__ RulesDAO.png}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\end{itemize}
		\item[] \file{+ query(target: RuleTarget): RuleArray} \\
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{images/Class__interface__ TasksDAO.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{images/Class__interface__ STTModule.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{images/Class__interface__ UsersDAO.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{images/Class__interface__ MembersDAO.png}
	\caption{Back-end::Utility:: MembersDAO}
\end{figure}
\begin{itemize}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{images/Class__interface__ AgentsDAO.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{images/Class__interface__ VAModule.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{images/Class__interface__ WebhookService.png}
...
Questa classe implementa l'interfaccia della libreria esterna RxJS::Observer;
	...
	\begin{itemize}
		...
		\item[] \file{+ <<Create>> createPausableObserver(onError: function(error: Error) : void, onNext: function(data: Object) : void, onComplete: function(): void): PausableObserver} \\
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{images/Class__interface__ ApplicationRegistryClient.png}
