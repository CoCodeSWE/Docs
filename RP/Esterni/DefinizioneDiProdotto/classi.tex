...
\begin{itemize}
	...
	\begin{itemize}
		...
		Attributo che permette di contattare \file{RulesDAO}, il quale fornisce i meccanismi di accesso al dati relativi alle direttive;
		\item[] \file{- users: UsersDAO} \\
		Attributo che permette di contattare \file{UsersDAO}, il quale fornisce i meccanismi di accesso ai dati relativi agli utenti registrati;
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			Parametro contenente;
		\end{itemize}
		\item[] \file{+ <<Create>> createAdministrationWebhookService(rulesdao: RulesDAO, usersdao: UsersDAO, jwt: JSONWebTokenModule): AdministrationWebhookService} \\
...
\begin{itemize}
	...
	\begin{itemize}
		...
		Cognome del membro dell'azienda;
	\end{itemize}
\end{itemize}
\FloatBarrier
