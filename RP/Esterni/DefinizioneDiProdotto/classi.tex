...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item OUT \hyperlink{<<interface>> WebhookService_label}{\file{<<interface>> WebhookService}}
	\end{itemize}
\end{itemize}
\FloatBarrier
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item \file{guest\_id: String} \\
			Parametro contenente il'identificativo dell'ospite del quale si vogliono ottenenre le conversazioni. Nel caso in cui sia vuoto, verranno restituite le conversazioni di tutti gli ospiti;
		\end{itemize}
		\item[] \file{+ removeConversation(session\_id: String): ErrorObservable} \\
		...
		\begin{itemize}
			...
			Parametro contenente l'id della sessione della conversazione da eliminare;
		\end{itemize}
		\item[] \file{+ <> createConversationsDAODynamoDB(db: AWS::DynamoDB): ConversationsDAODynamoDB} \\
...
\begin{itemize}
	...
	\begin{itemize}
		...
		Attributo contenente i parametri con i quali la funzione verrà chiamata;
	\end{itemize}
	\item \textbf{Relazioni con le altre classi}:
	\begin{itemize}
		\item IN \hyperlink{Rule_label}{\file{Rule}}
...
\begin{itemize}
	...
	\item \textbf{Relazioni con le altre classi}:
	\begin{itemize}
		\item IN \hyperlink{STTWatsonAdapter_label}{\file{STTWatsonAdapter}}
		\item IN \hyperlink{VocalAPI_label}{\file{VocalAPI}}
	\end{itemize}
\end{itemize}
\FloatBarrier
...
Vengono offerte funzionalità che permettono:
\begin{itemize}
\item la reazione a dati di risposta arrivati dal \file{Back-end};
\item la definizione di ciò che va a comporre un'applicazione;
\item il salvataggio dello stato di un'applicazione;
\item il cambio da un'applicazione a un'altra.
\end{itemize}
\subsubsection{Classi}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		Metodo che permette la registrazione di una applicazione nell'IApplicationRegistryClient. Questo metodo deve però impedire l'inserimento di package "Parziali" di RegistryPackage, ovvero un package di tipo \file{ApplicationPackage};\\
		Parametri:
		\begin{itemize}
			\item \file{name: String} \\
...
\item di notificare alle classi interessate la fine della registrazione audio di una richiesta dell'utente al \file{Back-end}.
\end{itemize}
