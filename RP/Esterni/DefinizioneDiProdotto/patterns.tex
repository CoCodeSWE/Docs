...
Data la scelta di appoggiarsi all'infrastruttura \gl{Amazon Web Services} (AWS) per lo sviluppo del sistema, il gruppo ha deciso di utilizzare l'AWS SDK per JavaScript in Node.js per
