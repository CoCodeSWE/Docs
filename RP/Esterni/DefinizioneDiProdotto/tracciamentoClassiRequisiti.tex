...
\hyperref[Back-end::Auth::<<interface>> UsersDAO]{\texttt{Back-end::Auth::<<interface>> UsersDAO}} & RFO2.2\\
& RFO2.2.1\\ \hline
\hyperref[{Back-end::Auth::SRUser]{\texttt{Back-end::Auth::SRUser}} & RFO1\\
& RFO1.1.2\\
& RFO1.1.2.1\\
& RFF1.1.2.2\\
& RFO2\\ \hline\hyperref[Back-end::Auth::User]{\texttt{Back-end::Auth::User}} & RFO1\\
& RFO1.1.2\\
& RFO1.1.2.1\\
& RFF1.1.2.2\\
& RFF1.2\\ \hline
\hyperref[Back-end::Auth::UsersService]{\texttt{Back-end::Auth::UsersService}} & RFD9\\
& RFD9.1\\
& RFD9.1.1\\
& RFD9.1.1.1\\
& RFF9.1.1.2\\
& RFD9.1.3\\ \hline
\hyperref[Back-end::Auth::VocalLoginModule]{\texttt{Back-end::Auth::VocalLoginModule}} & RFO1\\
& RFO1.1.2\\
& RFO1.1.2.1\\ \hline
