...
\begin{document}
  ...
  di questa fase è quello di consegnare al proponente un \gl{prodotto} qualificato.

  \subsection{Periodo V - \gl{Validazione}}

  In questa fase finale del progetto viene effettuata la \gl{validazione} del sistema ed il
