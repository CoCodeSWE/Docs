...
\begin{document}
  ...
  In questo periodo inizia la progettazione dettagliata del \gl{sistema}, nella quale si definiscono
  ...
  Durante questo periodo viene scritto il codice del \gl{sistema} e viene incrementata la progettazione di dettaglio. L'obbiettivo di questa fase è quello di consegnare al \gl{proponente} un \gl{prodotto} qualificato.
