...
\subsection{Livello tecnologico}
		...
		\textbf{Descrizione}: per lo svolgimento e l'implementazione del \gl{progetto}, il team dovrà utilizzare una serie di tecnologie che nessun membro ha mai utilizzato;
