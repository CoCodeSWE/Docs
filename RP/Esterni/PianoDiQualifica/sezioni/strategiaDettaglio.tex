...
\section{La strategia di gestione della qualità nel dettaglio}
	...
	\subsection{Risorse}
	Per garantire un buon funzionamento del processo di \gl{verifica} verranno impiegati i seguenti tipi di risorse:
	\begin{itemize}
		\item risorse umane;
		\item risorse hardware;
		\item risorse \gl{software}.
	\end{itemize}

		\subsubsection{Risorse necessarie}

			\paragraph{Risorse umane}
			Le risorse umane necessarie al processo di verifica sono i \VERP{} e il \RESP{}. Informazioni più dettagliate sui ruoli sono riportate nelle \NPdoc{}.
			...
			Le risorse software necessarie alla verifica sono gli strumenti software che eseguono controlli sui documenti e verificano che non violino le \NPdoc{}.
		...
		\subsubsection{Risorse disponibili}
			...
			\paragraph{Risorse umane}
			Tutti i membri del gruppo sono a disposizione per eseguire operazioni di verifica. Ognuno dei componenti, a turno, ricoprirà il ruolo di \RESP{} o di \VER{} come definito nel \PPdoc{}.
			...
			Sarà disponibile anche il \gl{sistema} di sollevamento delle \gl{issue} offerto dalla piattaforma \gl{GitHub}. Per maggiori informazioni sulla procedura di sollevamento e gestione delle issue si veda
			il documento \NPdoc{}.
	...
	\subsection{Misure e metriche}
		...
		\begin{itemize}
			...
			\item \textbf{Ottimale}: valore accettabile, l’oggetto sottoposto a verifica ha raggiunto le massime aspettative del \gl{team}.
		\end{itemize}
		...
		Il metodo di denominazione delle metriche è descritto in dettaglio nel documento \NPdoc{}.
			...
			La presente metrica indica se le attività di \gl{progetto} sono in anticipo o in ritardo rispetto a quelle pianificate nel \PPdoc{}. \\
			...
			La presente metrica indica se i costi alla data corrente sono maggiori o minori rispetto a quanto dichiarato nel \PPdoc{}. \\
