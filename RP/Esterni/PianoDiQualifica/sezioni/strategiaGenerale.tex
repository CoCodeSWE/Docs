...
\section{Visione generale della strategia di gestione della qualità}
	\subsection{Obiettivi qualitativi}
		...
		Ogni obiettivo viene definito in modo quantitativo per permettere al \gl{team} di valutarne il raggiungimento.
		...
		È prevista la realizzazione di due tipologie di prodotto: \gl{software} e documenti.
