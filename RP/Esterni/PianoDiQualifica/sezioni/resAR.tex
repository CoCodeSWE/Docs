...
\section{Resoconto delle attività di \gl{verifica} - fase AR}
...
\begin{table}[h]
			...
			Tali valori sono dovuti al fatto che l’attività degli \AMMP{} ha richiesto più tempo del previsto in quanto è stato necessario modificare alcune funzioni del \gl{software} utilizzato per il tracciamento dei requisiti e dei casi
