...
\def\SOMMARIO{Documento contenente l'analisi degli SDK dei principali assistenti virtuali relativo al prodotto \PROGETTO{} determinato dal gruppo \GRUPPO{} nel corso della realizzazione del progetto \PROGETTO.}
...
Questo documento riporta un'analisi eseguita dal gruppo \GRUPPO{} sui principali SDK di assistenti virtuali presenti sul mercato. L'analisi in questione ha lo scopo di mettere in mostra i punti di forza e le debolezze degli SDK presi in considerazione.
...
\begin{itemize}
	...
	\item compatibilità con molti sistemi operativi, tra cui: iOS, Android, Windows Phone, Raspberry Pi, \gl{Python} e \gl{C++}.;
...
\section{API.AI}
	...
	\end{minipage}
	\subsection{Caratteristiche}
	API.AI fornisce SDK per i principali liguaggi di programmazione tra i quali \gl{C++}, \gl{C\#}, Java, Node.js, JavaScript e \gl{Python}. Inoltre può essere integrato con Amazon Echo e Microsoft Cortana.\\
...
\newpage
	...
	\begin{table}[h]
		...
		\hline 
		Piattaforme e linguaggi  di prog. supportati & \textit{Node.js; \gl{Python}; Ruby; HTTP} & \rule[-0.2cm]{0cm}{0.6cm} \textit{Android; iOS; Apple Watch; Node.js; Cordova; Unity; \gl{C\#}; Xamarin; Windows Phone; \gl{Python}; JavaScript; PHP; Botkit; \gl{C++}; \gl{Mac OS X}; HTML5; Ruby} & \textit{iOS} & qualsiasi linguaggio permetta di accettare richieste \textit{HTTPS}\\
		\hline 
