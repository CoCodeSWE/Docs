...
\def\SOMMARIO{Verbale dell'incontro esterno in data 2017-02-07 per il \gl{capitolato} \quotes{\CAPITOLATO{}}  del gruppo \GRUPPO.}
...
\maketitle
\begin{diario}
  \modifica{Mattia Bottaro}{\RESP}{Approvazione del documento}{2017-02-07}{1.0.0}
  \modifica{Simeone Pizzi}{\VER}{Verifica del documento}{2017-02-07}{0.1.0}
  \modifica{Mattia Bottaro}{\RESP}{Stesura documento e verbalizzazione della riunione}{2017-02-07}{0.0.1}
\end{diario}
\newpage
\tableofcontents
