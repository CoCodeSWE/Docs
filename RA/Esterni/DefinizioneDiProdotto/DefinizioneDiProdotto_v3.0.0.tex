...
\begin{document}
	...
	\begin{diario}
		\modifica{Pier Paolo Tricomi}{\RESP}{Approvazione del documento}{2017-06-05}{3.0.0}
		\modifica{Mauro Carlin}{\VER}{\gl{Verifica} del documento}{2017-05-17}{2.1.0}
		\modifica{Mattia Bottaro}{\PJ}{Spostato package Utility in ogni package che lo utilizza}{2017-05-15}{2.0.2}
	    \modifica{Mattia Bottaro}{\PJ}{Aggiunto package Curiosity alla specifica delle componenti (\ref{curiosity})}{2017-05-15}{2.0.1}
