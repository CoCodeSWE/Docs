...
Le funzioni asincrone che ottengono i dati richiesti tramite \gl{callback} sono rappresentati da una richiesta raffigurata da una freccia asincrona (freccia continua con punta aperta, notazione UML 2.5), e da una risposta chiamata \file{callback()} rappresentata anch'essa da una freccia asincrona, per indicare che la risposta sarà restituita una volta che la risorsa richiesta diverrà disponibile.
