...
\gl{Package} contenente tutte le componenti che costituiscono il back-end. Le componenti sono organizzate seguendo un'architettura a \gl{microservizi}.   \begin{figure}[h] \centering \includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{images/diagrams/back-end/Official_Backend_0304/Back-end.png}
...
\begin{itemize}
	...
	\end{itemize}
\end{itemize}
\subparagraph{APIGateway::Utility}
Package utilizzato da APIGateway e illustrato in \ref{Utility}.
\FloatBarrier
\newpage
...
;
	...
	\end{itemize}
\end{itemize}
\subparagraph{Conversations::Utility}
Package utilizzato da Conversations e illustrato in \ref{Utility}.
\FloatBarrier
\newpage
\subsubsection{Back-end::Curiosity}\label{curiosity}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.5\textwidth,height=\textheight,keepaspectratio]{images/ClassCuriosityDAO.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.35\textwidth,height=\textheight,keepaspectratio]{images/ClassCuriosity.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.50\textwidth,height=\textheight,keepaspectratio]{images/ClassCuriosityObserver.png}
...
\begin{itemize}
	...
	\end{itemize}
\end{itemize}
\subparagraph{Curiosity::Utility}
Package utilizzato da Curiosity e illustrato in \ref{Utility}.
\FloatBarrier
\newpage
...
\begin{itemize}
	...
	\end{itemize}
\end{itemize}
\subparagraph{Members::Utility}
Package utilizzato da Members e illustrato in \ref{Utility}.
\FloatBarrier
\newpage
...
Dove \file{msg} è un oggetto di tipo \file{NotificationMessage}, mentre \file{send\_to} è una stringa contenente il mittente del messaggio;
	...
	\end{itemize}
\end{itemize}
\subparagraph{Notifications::Utility}
Package utilizzato da Notifications e illustrato in \ref{Utility}.
\FloatBarrier
\newpage
...
\begin{itemize}
	...
	\end{itemize}
\end{itemize}
\subparagraph{Rules::Utility}
Package utilizzato da Rules e illustrato in \ref{Utility}.
\FloatBarrier
\newpage
...
È soggetta ad una constructor-based dependency injection, la quale ha come oggetto un \file{RequestPromiseModule};
	...
	\end{itemize}
\end{itemize}
\subparagraph{Users::Utility}
Package utilizzato da Users e illustrato in \ref{Utility}.
\FloatBarrier
\newpage
...
;
	...
	\end{itemize}
\end{itemize}
\subparagraph{VirtualAssistant::Utility}
Package utilizzato da VirtualAssistant e illustrato in \ref{Utility}.
\FloatBarrier
\newpage
\subsubsection{Utility}\label{Utility}
Package contenente classi e interfacce, dallo scopo generico, utili a molti package del back-end.
