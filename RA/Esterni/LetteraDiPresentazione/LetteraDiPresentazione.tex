...
\begin{document}
  \begin{letter}{
    ...
    \end{itemize}
    Oltre alla documentazione, viene consegnato il codice sorgente relativo al prodotto commissionato. Il codice sorgente è reperibile al percorso: \file{RA/AtAvI/src}.\\ Il costo finale del lavoro effettuato dal gruppo è di \textbf{13.848,00 \euro}, come analizzato nel \PPdoc{}.
    \newpage
