...
\newpage\subsection{UC9: Riconoscimento amministratore tramite assistente}
\label{UC9}
\begin{figure}[h]
\centering
...
&\\
\textbf{Attori} & Assistente Virtuale, Utente.\\[7pt]
\textbf{Descrizione} & Il sistema offre all'utente la possibilità di autenticarsi come amministratore del sistema tramite l'assistente virtuale.\\[7pt]
\textbf{Precondizione} & Il sistema ha riconosciuto l'utente come possibile amministratore del sistema.\\[7pt]
\textbf{Postcondizione} & Il sistema ha autenticato l'utente come amministratore tramite l'assistente virtuale.\\[7pt]
