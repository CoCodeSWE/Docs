...
\subsection{Livello tecnologico}
	...
	\begin{table}[h]
        ...
        \textbf{\PerC}& in seguito alle strategie adottate nei periodi precedenti, il rischio non si è presentato \\
				\hline
				\textbf{\PerV}& il rischio non si è presentato \\
				\hline
...
\begin{table}[h]
        ...
        Inoltre sono state ridotte le ore dedicate all'attività degli \ANP{} e \VERP{} in ragione di un incremento delle ore dedicate alle attività dei \PJP{} \\ \hline
				...
				\hline
				\textbf{\PerV}& il rischio si è presentato, infatti è stato utilizzato un maggior numero di risorse rispetto a quanto pianificato per la progettazione, codifica e verifica delle componenti necessarie a soddisfare i requisiti desiderabili \\
				\hline
		\end{tabular}
