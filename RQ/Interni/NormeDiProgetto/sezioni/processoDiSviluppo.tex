...
\begin{itemize}
		...
		\item fissare i vincoli tecno\gl{log}ici.
\end{itemize}
...
\end{itemize}
 ...
 \begin{itemize}
 	...
 	\item \textbf{Diagrammi dei \gl{package}s}: raggruppamenti di classi in una unità di livello più alto;
...
\paragraph{Regole \gl{JavaScript}}
