...
\subparagraph{I loop for..in devono avere filtri sugli oggetti}
...
\subparagraph{If annidati dovrebbero essere uniti}
...
\subparagraph{Variabili devono essere dichiarate in modo esplicito prima di essere usate}
