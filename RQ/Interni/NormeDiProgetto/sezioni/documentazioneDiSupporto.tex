...
Questo repository è dedicato all'archiviazione dei file per generare tutta la documentazione che il team vuole produrre.\\
...
Questo repository è dedicato all'archiviazione dei file contenenti il codice sorgente per realizzare il prodotto.\\
Al fine di mantenere ordine e coerenza tra i file, il repository è così strutturato:
\begin{itemize}
	\item \PROGETTO
	\begin{itemize}
	...
	\end{itemize}
\end{itemize}
Questo repository dovrà seguire la gerarchia dei package descritta nel documento \DPdoc.
\paragraph{Commit}
