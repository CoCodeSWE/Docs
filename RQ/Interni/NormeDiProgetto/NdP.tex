...
\begin{diario}
	\modifica{CHI}{\AMM}{Aggiunta sezione \ref{req prog} riguardante i \PJP.}{2017-04-23}{4.0.4}
	\modifica{CHI}{\AMM}{Estesi paragrafi \ref{Specifica tecnica} e \ref{definizione prodotto}.}{2017-04-23}{4.0.4}
	...
	\modifica{CHI}{\AMM}{Aggiunte norme sull'intestazione dei metodi delle classi (\ref{intestazione}).}{2017-04-22}{4.0.3}
