...
\signature{
  ...
  \includegraphics{firme/maurocarlin.png} \\
  Mauro Carlin
}
\date{2017-05-07}
\place{Padova}
...
\begin{document}
  \begin{letter}{
    ...
    \begin{itemize}
      ...
      \item \ARdoc{} \ARfile{};
      \item \DPdoc{} \DPfile{};
      \item \doc{Verbali delle riunioni interne} \file{RP/Interni/Verbali Interni}
      \item \doc{Verbali delle riunioni esterne} \file{RP/Esterni/Verbali Esterni}
    \end{itemize}
