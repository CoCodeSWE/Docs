...
\begin{document}
  ...
  di questo periodo è quello di consegnare al proponente un \gl{prodotto} qualificato.

  \subsection{Periodo V - \gl{Validazione}}

  In questo periodo finale del progetto viene effettuata la \gl{validazione} del sistema ed il
