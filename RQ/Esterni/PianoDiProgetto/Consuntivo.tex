...
state necessarie un minor numero di ore, corrispondente a quanto pianificato.
	\paragraph{Preventivo a finire}
	L'impegno impiegato per le attività progettuali negli ultimi due periodi, permetterà l'utilizzo di un minor numero di ore da parte dei \PJP{} in futuro, a favore di ruoli come \PMP{} e \VERP{}. Sarà quindi possibile ridurre le ore dedicate alla progettazione per i periodi rimanenti.
	\clearpage
\end{document}
