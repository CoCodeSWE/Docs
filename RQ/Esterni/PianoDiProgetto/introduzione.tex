\section{Introduzione}
	...
	\subsubsection{Riferimenti Normativi}
		\begin{itemize}
			...
			\url{http://www.math.unipd.it/~tullio/IS-1/2016/Progetto/C2.pdf} (visitato in data 2017-05-07);
			\item Rappresentazione date \\
			\url{https://en.wikipedia.org/wiki/ISO_8601} (visitato in data 2017-05-07);
			\item Composizione processo di sviluppo \\
			\url{https://en.wikipedia.org/wiki/ISO/IEC_12207} (visitato in data 2017-05-07).
	...
	\end{itemize}
	    \subsubsection{Riferimenti Informativi}
	    	\begin{itemize}
	    		...
	    		\begin{itemize}
	    			\item Parte 4 - Software management pagine (618 - 732);
	    		\end{itemize}
	    		\item \textbf{Slides corso Ingegneria del Software}: \\ \url{http://www.math.unipd.it/~tullio/IS-1/2016/} (visitato in data 2017-05-07);
	    	\end{itemize}
