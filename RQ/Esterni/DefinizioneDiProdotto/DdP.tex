...
\def\VERSIONE{1.0.0}
\def\DATA{2017-03-30}
\def\REDATTORE{Simeone Pizzi \\ & Luca Bertolini \\ & Pier Paolo Tricomi \\ & Mattia Bottaro}
\def\VERIFICATORE{Mauro Carlin \\ & Nicola Tintorri}
...
\begin{diario}
	\modifica{da sistemare il nome}{\PJ}{Modificata la query string dell'endpoint con metodo GET del microservizio Rules}{2017-04-23}{1.0.4}
	\modifica{da sistemare il nome}{\PJ}{Migliorate le descrizioni sui diagrammi dei packages}{2017-04-22}{1.0.3}
	\modifica{da sistemare il nome}{\PJ}{Spostata la sezione dei diagrammi di sequenza (\ref{sequenza}) dopo quella delle componenti di dettaglio (\ref{componenti})}{2017-04-22}{1.0.2}
	\modifica{da sistemare il nome}{\PJ}{Rimosso capitolo "Diagrammi riassuntivi dei package" ed aggiunte immagini package in capitolo \ref{componenti} (Specifica delle componenti)}{2017-04-22}{1.0.1}
