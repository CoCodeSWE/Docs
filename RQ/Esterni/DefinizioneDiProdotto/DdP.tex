...
\begin{diario}
	\modifica{Mauro Carlin}{\RESP}{Approvazione del documento}{2017-04-24}{2.0.0}
	\modifica{Mattia Bottaro}{\PJ}{Corretti errori rilevati nella verifica}{2017-04-23}{1.1.1}
	\modifica{Nicola Tintorri}{\VER}{Verifica del documento}{2017-04-23}{1.1.0}
	\modifica{Andrea Magnan}{\PJ}{Modificata la query string dell'endpoint con metodo GET del microservizio Rules}{2017-04-23}{1.0.4}
	\modifica{Luca Bertolini}{\PJ}{Migliorate le descrizioni sui diagrammi dei packages}{2017-04-22}{1.0.3}
	\modifica{Simeone Pizzi}{\PJ}{Spostata la sezione dei diagrammi di sequenza (\ref{sequenza}) dopo quella delle componenti di dettaglio (\ref{componenti})}{2017-04-22}{1.0.2}
	\modifica{Mattia Bottaro}{\PJ}{Rimosso capitolo "Diagrammi riassuntivi dei package" ed aggiunte immagini package in capitolo \ref{componenti} (Specifica delle componenti)}{2017-04-22}{1.0.1}
