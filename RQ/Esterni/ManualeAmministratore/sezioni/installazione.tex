...
\end{figure}
\paragraph{Configurazione}
Dopo aver effettuato l'accesso, selezionare il menù degli \gl{agent} a sinistra (figura \ref{fig:menuapi}) e scorrerlo fino in fondo, selezionando "Create new agent" (figura). \\
...
Inserire nell'apposita schermata (figura) i seguenti dati:
\begin{itemize}
