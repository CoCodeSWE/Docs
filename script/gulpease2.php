...
function gulpease($path) {
  ...
  $GLOBALS['sum_lettere']=$GLOBALS['sum_lettere']+$lettere;
  //echo $GLOBALS['sum_lettere']."\n";
  //$sum_lettere=$sum_lettere+$lettere;
  return (round(($lettere)*(89 + (($frasi * 300 - $lettere * 10) / $parole))));
}
...
function median($array) {
  ...
  return (($sum/sizeof($array))/$GLOBALS['sum_lettere']);
}
