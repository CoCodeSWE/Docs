...
Java e Javascript tramite tecnologie web.
	...
	\begin {itemize}
	\item \textbf{Java} o \textbf{JavaScript}: come linguaggio del codice che il \gl{software} dovrà generare;
	\item \textbf{\gl{UML}}: come standard per i diagrammi; ***da tenere?
