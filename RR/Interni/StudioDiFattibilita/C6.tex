...
Java e Javascript tramite tecnologie web.
	...
	\begin {itemize}
	\item \textbf{Java} o \textbf{\gl{JavaScript}} (come linguaggio del codice che il \gl{software} dovrà generare);
	...
	Il team ha deciso di scartare questo \gl{capitolato},nonostante la sua chiarezza di esposizione e l'uso di tecnologie conosciute, a causa di una mancanza di interesse in esso e il suo ambito di utilizzo.