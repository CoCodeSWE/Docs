...
client di messaggistica.
	...
	Il \gl{progetto} fornisce un servizio in grado di facilitare la lettura alle persone affette da dislessia tramite l'utilizzo di dispositivi mobili. 
	\subsection {Dominio tecnologico}
Il \gl{progetto} prevede che l'applicazione utilizzi il motore di sintesi vocale Flexible and Adaptive Text To Speech, un'applicazione web che
