...
requisiti (si utilizza la tecnica dei \gl{casi d'uso}). Il tracciamento dei requisiti avviene tramite ... 
...
\subsubsection{Strumenti}
  \paragraph{Astah}
  Astah è uno strumento di modellazione \gl{UML}. Verrà quindi usato per la produzione di diagrammi \gl{UML}. Viene utilizzata la versione 7.0 o superiori.
\begin{figure}[h]
\centering
