...
\label{sec:RiassuntoRiunione}
 ...
 \begin{itemize}
  ...
  \end{itemize}
  \item D1.4 - Strumenti: sono stati decisi solo alcuni strumenti da utilizzare. Per la stesura e formattazione dei documenti si utilizzerà il linguaggio \LaTeX{}{} unito all'editor \gl{Texmaker}. Per il versionamento si utilizzerà \gl{Git} unito al servizio di host \gl{GitHub}. 
  \item D1.5 - Prime direttive: in base ai ruoli prima decisi, sono stati assegnati i primi compiti quali: formazione di un \gl{template} \LaTeX{}{}, stesura struttura documenti, primi contenuti.
 \end{itemize}
