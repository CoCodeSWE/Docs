...
\label{sec:RiassuntoRiunione}
 ...
 \begin{itemize}
  ...
  \item D1.2 - Scelta \gl{capitolato}: dopo una votazione è stato scelto il \gl{capitolato} C2 (\gl{progetto} \PROGETTO) proposto dall'azienda \PROPONENTE.
  ...
  \end{itemize}
  \item D1.4 - Strumenti: sono stati decisi solo alcuni strumenti da utilizzare. Per la stesura e formattazione dei documenti si utilizzerà il linguaggio \\gl{LaTeX}{} unito all'editor \gl{Texmaker}. Per il versionamento si utilizzerà \gl{Git} unito al servizio di host \gl{GitHub}. 
  \item D1.5 - Prime direttive: in base ai ruoli prima decisi, sono stati assegnati i primi compiti quali: formazione di un \gl{template} \\gl{LaTeX}{}, stesura struttura documenti, primi contenuti.
 \end{itemize}
...
\subsection{Tematiche in sospeso} 
  ...
  \item S1.3 - Requisiti e specifiche del \gl{software}: non tutti i requisiti e le specifiche necessarie al \gl{software} sono colte dal team. È necessario chiarire i dubbi alla prima riunione con il \gl{proponente}.
  \end{itemize}
\end{document}
