...
\parola{Software Development Kit (SDK)}{Un software development kit è un insieme di strumenti per lo sviluppo e la documentazione di software.}
...
\parola{Structured Query Language (SQL)}{È un linguaggio standardizzato per database basati sul modello relazionale.}
