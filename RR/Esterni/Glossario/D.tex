...
\parola{DBMS}{Acronimo di Database Management System, è un sistema software progettato per consentire la creazione, la manipolazione e l'interrogazione efficiente di un database.}
...
\parola{DynamoDB}{Servizio di database NoSQL offerto da Amazon Web Services.}