...
\parola{C++}{ È un linguaggio di programmazione orientato agli oggetti.}
...
\parola{Capability Maturity Model (CMM)}{"Capability Maturity Model". È un approccio al miglioramento dei processi il cui obiettivo è di aiutare un'organizzazione a migliorare le sue prestazioni. Il CMM può essere usato per guidare il miglioramento dei processi all'interno di un progetto, una divisione o un'intera organizzazione.}
