...
\section{La strategia di gestione della qualità nel dettaglio}
	...
	\end{itemize}
		...
		\subsubsection{Risorse disponibili}
			...
			\paragraph{Risorse umane}
			Tutti i membri del gruppo sono a disposizione per eseguire operazioni di verifica. Ognuno dei componenti, a turno, ricoprirà il ruolo di \RESP{} o di \VER{} come nel \PPdocRR{}.
	...
	\subsection{Misure e metriche}
		...
		Il metodo di denominazione delle metriche è descritto in dettaglio nel documento \NPdocRR{}.
			...
			attraverso strumenti software.
				...
				\subparagraph{Indice di leggibilità - MPDD1}
				...
				\subparagraph{Errori ortografici rinvenuti e non corretti - MPDD2}
				...
				\subparagraph{Errori concettuali rinvenuti e non corretti - MPDD3}
			...
			\end{table}
				...
				\subparagraph{Copertura requisiti obbligatori - MPDS1}
				...
				\subparagraph{Copertura requisiti desiderabili - MPDS2}
				...
				\subparagraph{Test passati richiesti - MPDS3}
				...
				\subparagraph{Failure Avoidance - MPDS4}
				...
				\subparagraph{Breakdown Avoidance - MPDS5}
