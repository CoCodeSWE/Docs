...
\section{Visione generale della strategia di gestione della qualità}
	\subsection{Obiettivi qualitativi}
		...
		specificando valori minimi e valori ottimali.
			...
			Per rendere le performance dei processi costantemente migliorabili e perguire gli obiettivi quantitativi di miglioramento si è deciso di utilizzare il modello Capability Maturity Model (\gl{CMM}).
			...
			Riassumendo: \\ \\
			\textbf{Modello utilizzato:} \gl{CMM}; \\ \\
			\textbf{Soglia di accettabilità:} livello 2 previsto da \gl{CMM}; \\ \\
			\textbf{Soglia di ottimalità:} livello 4 previsto da \gl{CMM}. \\ \\
		...
		Per ognuno di essi, vengono definiti i criteri con cui si effettuano le misurazioni qualitative, specificando valori minimi e valori ottimali.
			...
			\begin{itemize}
				...
				\item il \gl{prodotto} possiede le funzionalità descritte all’interno dei requisiti desiderabili;
