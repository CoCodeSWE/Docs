...
\item \textbf{portabilità:}  la capacità del software di essere trasportato da un ambiente di lavoro ad un altro.
\end{itemize}
...
\item \textbf{produttività:} la capacità di permettere all’utente di utilizzare un numero di risorse in relazione all’efficienza raggiunta in uno specifico contesto di utilizzo;
...
Le metriche esterne sono scelte in base alle caratteristiche che il prodotto
