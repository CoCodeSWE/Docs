 In questa sezione verranno presentati i requisiti individuati dal team durante l'analisi del \gl{capitolato}
...
\begin{itemize}
	...
	\begin{itemize}
		\item \gl{Capitolato}: requisito dedotto direttamente dall'analisi del \gl{capitolato};
