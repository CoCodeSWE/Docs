...
\subsubsection{UC1.1.1: Comunicazione nome e cognome}
\label{UC1.1.1}
\begin{longtable}{l|p{10cm}}
\rowcolor[gray]{0.8} \multicolumn{2}{c}{} \\
...
\newpage\subsubsection{UC1.3.1: Comunicazione frase di riconoscimento amministratore}
\label{UC1.3.1}
\begin{longtable}{l|p{10cm}}
\rowcolor[gray]{0.8} \multicolumn{2}{c}{} \\
...
\newpage\subsubsection{UC2.1.1.3.1: Inserimento target azienda}
\label{UC2.1.1.3.1}
\begin{longtable}{l|p{10cm}}
\rowcolor[gray]{0.8} \multicolumn{2}{c}{} \\
...
\newpage\subsubsection{UC2.1.1.4: Inserimento privilegi direttiva}
\label{UC2.1.1.4}
\begin{longtable}{l|p{10cm}}
\rowcolor[gray]{0.8} \multicolumn{2}{c}{} \\
...
\textbf{Precondizione} & Il sistema pone all'ospite alcuni indovinelli.\\[7pt]
\textbf{Postcondizione} & Il sistema riceve le risposte dell'ospite agli indovinelli.\\[7pt]
...
\newpage\subsubsection{UC4.1.2.1: Conferma reset password amministratore}
\label{UC4.1.2.1}
\begin{longtable}{l|p{10cm}}
\rowcolor[gray]{0.8} \multicolumn{2}{c}{} \\
...
\hline
&\\
\textbf{Attori} & Amministratore, Assistente Virtuale, Ospite, Super Amministratore.\\[7pt]
