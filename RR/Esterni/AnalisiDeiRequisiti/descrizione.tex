...
Il \gl{prodotto}, dopo avergli dato il benvenuto, dovrà richiedere all'ospite alcune informazioni riguardanti la sua visita all'ufficio di \PROPONENTE. 
...
Il \gl{browser} che verrà utilizzato dovrà essere compatibile con gli standard \gl{HTML5}, \gl{CSS3} e \gl{JavaScript}.