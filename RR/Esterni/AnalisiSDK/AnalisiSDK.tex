...
<<<<<<< HEAD
	\item compatibilità con molti sistemi operativi, tra cui: \gl{iOS}, \gl{Android}, \gl{Windows Phone}, \gl{Raspberry Pi}, Python e \gl{C++}.;
...
>>>>>>> aae817fcc591304420a0212fd563e4e3cabd2711
\end{itemize}	
...
\section{API.AI}
	...
	\end{minipage}
	\subsection{Caratteristiche}
	\gl{API}.AI fornisce \gl{SDK} per i principali liguaggi di programmazione tra i quali \gl{C++}++, \gl{C++}\#, \gl{Java}, \gl{Node.js}, Javascript e \gl{Phyton}. Inoltre può essere integrato con \gl{Amazon Echo} e \gl{Microsoft Cortana}.\\
...
\newpage
	...
	\begin{table}[h]
		...
		\hline 
		Piattaforme e linguaggi  di prog. supportati & \textit{\gl{Node.js}; Python; \gl{Ruby}; \gl{HTTP}} & \rule[-0.2cm]{0cm}{0.6cm} \textit{\gl{Android}; \gl{iOS}; \gl{Apple} Watch; \gl{Node.js}; \gl{Cordova}; \gl{Unity}; \gl{C++}\#; \gl{Xamarin}; \gl{Windows Phone}; Python; \gl{JavaScript}; \gl{PHP}; \gl{Botkit}; \gl{C++}++; Mac OS X; HTML; \gl{Ruby}} & \textit{\gl{iOS}} & qualsiasi linguaggio permetta di accettare richieste \textit{\gl{HTTPS}}\\
		\hline 
